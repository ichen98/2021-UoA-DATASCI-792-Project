...
```{r plotting the min, mean, max for each pos, cache=TRUE}
...
<ol>
  <li>`Distance Speed Zone 5 (m)`</li>
  <li>`Speed Max (km/h)`</li>
  <li>`Distance Speed Zone 4 (m)`</li>
  <li>`Duration HR Zone 4 (s)`</li>
  <li>`Decelerations Zone 3 (num)`</li>
</ol>
...
<ol>
  <li>`Sprints Speed Zone 3 (num)`</li>
  <li>`Distance Speed Zone 3 (m)`</li>
  <li>`Body Impacts (num)`</li>
  <li>`Decelerations Zone 3 (num)`</li>
  <li>`Duration HR Zone 4 (s)`</li>
</ol>
...
<ol>
  <li>`Work Recovery Ratio` | 2:3</li>
  <li>`Duration HR Zone 5 (s)`</li>
  <li>`Sprints Hi-Inten (num)`</li>
  <li>`Sprints HR Hi-Inten (num)`</li>
  <li>`Body Impacts Grade 1 (num)`</li>
</ol>
...
<ol>
  <li>`Body Impacts (num)`</li>
  <li>`Duration HR Zone 4 (s)`</li>
  <li>`Sprints Speed Zone 4 (num)`</li>
  <li>`Body Impacts Grade 3 (num)`</li>
  <li>`Accelerations Zone 5 (num)`</li>
</ol>
...
<ol>
  ...
  <li>`Duration HR Zone 5 (s)`</li>
  <li>`Distance Speed Zone 5 (m)`</li>
  <li>`Body Impacts Grade 2 (num)`</li>
</ol>
...
<ol>
  <li>`Body Impacts (num)`</li>
  <li>`Distance Speed Zone 2 (m)`</li>
  <li>`Sprints Speed Zone 4 (num)`</li>
  <li>`Body Impacts Grade 2 (num)`</li>
  <li>`Hi Intensity Effort (num)`</li>
</ol>
...
<ol>
  <li>`Distance Speed Zone 1 (m)`</li>
  <li>`Duration Total (s)`</li>
  <li>`Work Recovery Ratio` | 1:1</li>
  <li>`Body Impacts (num)`</li>
  <li>`Distance Rate (m/min)`</li>
</ol>
...
<ol>
  ...
  <li>`Distance Speed Zone 3 (m)`</li>
  <li>`Speed Max (km/h)`</li>
  <li>`Sprints Speed Zone 5 (num)`</li>
  <li>`Accelerations Zone 4 (num)`</li>
</ol>
...
<ol>
  <li>`Distance Speed Zone 1 (m)`</li>
  <li>`Decelerations Zone 5 (num)`</li>
  <li>`Body Impacts Grade 2 (num)`</li>
  <li>`Accelerations Zone 4 (num)`</li>
  <li>`Sprints Speed Zone 5 (num)`</li>
</ol>
...
<ol>
  <li>`Accelerations Zone 5 (num)`</li>
  <li>`Duration Speed Hi-Inten (s)`</li>
  <li>`Work Recovery Ratio` | 2:3</li>
  <li>`Decelerations Zone 4 (num)`</li>
  <li>`Work Recovery Ratio` | 1:2</li>
  <li>`Accelerations Zone 3 (num)`</li>
</ol>
